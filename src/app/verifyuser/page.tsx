...
export default function Forget() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-[url('../../public/clouds.jpg')] bg-no-repeat bg-cover bg-center bg-fixed">
      <Toaster />
      ...
      <div className="text-center mb-12 text-4xl text-slate-100 font-medium">
        <h1>Find your account</h1>
          <h1 className="text-lg text-center">{loading && "Processing Data"}</h1>
        </div>
