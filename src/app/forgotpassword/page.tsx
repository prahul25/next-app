...
export default function ForgetPassword() {
  ...
  React.useEffect(() => {
    // Extract token from URL and set it in the state
  ...
  return <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-[url('../../public/mountain.jpg')] bg-no-repeat bg-cover bg-center bg-fixed">
  <Toaster />
